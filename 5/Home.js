...
// Что выведет этот код: alert( "1"[0] )?                          1     console.log(  "12"[1] ); = 2
// Чему равно 2 && 1 && null && 0 && undefined ?                   null   оператор И запинается на лжи.Вернутся первый false
// Есть ли разница между выражениями? !!( a && b ) и (a && b)?     нет ?

// Что выведет этот код: alert( null || 2 && 3 || 4 ); ?           3
// 3 оператор ИЛИ записаниется на тру. Вернутся первый true, Приоритет у && сначала выполнится он. 
